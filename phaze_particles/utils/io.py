...
class JSONWriter:
    ...
    def _process_data_for_json(self, data: Any) -> Any:
        ...
        if isinstance(data, np.ndarray):
            ...
            return {
                key: self._process_data_for_json(value) for key, value in data.items()
            }
...
class ResultsManager:
    ...
    def generate_filename(
        self, short_desc: str, timestamp: Optional[str] = None
    ) -> str:
        """
    ...
    def list_results(
        self, command: Optional[str] = None, subcommand: Optional[str] = None
    ) -> List[Path]:
        """
        List result files.
...
class ConfigLoader:
    ...
    def load_config(
        self, file_path: Union[str, Path], defaults: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
        """
    ...
    def load_config_with_defaults(
        self, file_path: Union[str, Path], defaults: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
...
class FileManager:
    ...
    def cleanup_directory(
        self, dir_path: Union[str, Path], keep_files: Optional[List[str]] = None
    ) -> int:
        """
        Clean up directory.
...
class DataExporter:
    ...
    def export_numpy_array(
        self, array: np.ndarray, filename: str, format: str = "npy"
    ) -> Path:
        """
