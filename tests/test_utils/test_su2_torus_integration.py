...
class TestSU2TorusIntegration(unittest.TestCase):
    ...
    def test_120deg_configuration_integration(self) -> None:
        ...
        field = self.su2_fields.create_field_from_torus(torus_120, "skyrmion", 1.0)
    ...
    def test_cuda_backend_integration(self) -> None:
        ...
        field = su2_fields_cuda.create_field_from_torus(torus_120, "skyrmion", 1.0)
    ...
    def test_performance_comparison(self) -> None:
        ...
        field_cpu = self.su2_fields.create_field_from_torus(torus_120, "skyrmion", 1.0)
        ...
        if self.su2_fields.is_cuda_available():
            su2_fields_cuda = SU2Fields(self.grid_size, self.box_size, use_cuda=True)
            torus_120_cuda = Torus120Degrees(
                radius=1.0, backend=su2_fields_cuda.backend
            )
